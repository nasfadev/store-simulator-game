...
[BurstCompile]
public struct AddRoofFloorJob : IJob
{
    public float3x2 ids;
        ...
        for (int y = minY; y < maxY + 1; y++)
        {
            for (int x = minX; x < maxX + 1; x++)
            {
                ...
                if (block6 && next)
                {
                    ...
                    UnityEngine.Debug.Log($"vertex1 block6 {blockTopID.c1.z}");
                    ...
                    if (blockTopID.c1.y < 0)
                    {
                        ...
                        vertsRefID1 = id;
                        indexRange++;
                        UnityEngine.Debug.Log($"vertex1 block6 {id}");
                        next = false;
                    }
                    else
                    {
                ...
                if (block7 && next)
                {
                    int id = IDBlock7;
                    int4x2 blockTopID = verticesTop[id];
                    UnityEngine.Debug.Log($"vertex1 block7 {blockTopID.c1.z}");
                    if (blockTopID.c1.z < 0)
                    {
                        ...
                        vertsRefID1 = id;
                        indexRange++;
                        UnityEngine.Debug.Log($"vertex1 block7 {id}");
                        next = false;
                    }
                    else
                    {
                ...
                if (block8 && next)
                {
                    ...
                    if (blockTopID.c1.w < 0)
                    {
                        ...
                        vertsRefID1 = id;
                        indexRange++;
                        UnityEngine.Debug.Log($"vertex1 block8 {id}");
                        next = false;
                    }
                    else
                    {
...

                {
                    ...
                    vertsRefID1 = -1;
                    vertexCount[0] += 1;
                    UnityEngine.Debug.Log($"vertex1 no block");
                ...
                if (block8 && next)
                {
                    ...
                    if (blockTopID.c1.z < 0)
                    {
                        ...
                        vertsRefID2 = id;
                        indexRange++;
                        UnityEngine.Debug.Log($"vertex2 block8 {id}");
                        next = false;
                    }
                    else
                    {
                ...
                if (block1 && next)
                {
                    ...
                    if (blockTopID.c1.w < 0)
                    {
                        ...
                        vertsRefID2 = id;
                        indexRange++;
                        UnityEngine.Debug.Log($"vertex2 block1 {id}");
                        next = false;
                    }
                    else
                    {
                ...
                if (block2 && next)
                {
                    ...
                    if (blockTopID.c1.x < 0)
                    {
                        ...
                        vertsRefID2 = id;
                        indexRange++;
                        UnityEngine.Debug.Log($"vertex2 block2 {id}");
                        next = false;
                    }
                    else
                    {
...

                {
                    ...
                    vertsRefID2 = -1;
                    vertexCount[0] += 1;
                    UnityEngine.Debug.Log($"vertex2 no block");
                ...
                if (block2 && next)
                {
                    ...
                    if (blockTopID.c1.w < 0)
                    {
                        ...
                        vertsRefID3 = id;
                        indexRange++;
                        UnityEngine.Debug.Log($"vertex3 block2 {id}");
                        next = false;
                    }
                    else
                    {
                ...
                if (block3 && next)
                {
                    ...
                    if (blockTopID.c1.x < 0)
                    {
                        ...
                        vertsRefID3 = id;
                        indexRange++;
                        UnityEngine.Debug.Log($"vertex3 block3 {id}");
                        next = false;
                    }
                    else
                    {
                ...
                if (block4 && next)
                {
                    ...
                    if (blockTopID.c1.y < 0)
                    {
                        ...
                        vertsRefID3 = id;
                        indexRange++;
                        UnityEngine.Debug.Log($"vertex3 block4 {id}");
                        next = false;
                    }
                    else
                    {
...

                {
                    ...
                    UnityEngine.Debug.Log($"vertex3 no block");
                ...
                if (block4 && next)
                {
                    ...
                    if (blockTopID.c1.x < 0)
                    {
                        ...
                        vertsRefID4 = id;
                        indexRange++;
                        UnityEngine.Debug.Log($"vertex4 block4 {id}");
                        next = false;
                    }
                    else
                    {
                ...
                if (block5 && next)
                {
                    ...
                    if (blockTopID.c1.y < 0)
                    {
                        ...
                        vertsRefID4 = id;
                        indexRange++;
                        UnityEngine.Debug.Log($"vertex4 block5 {id}");
                        next = false;
                    }
                    else
                    {
                ...
                if (block6 && next)
                {
                    ...
                    if (blockTopID.c1.z < 0)
                    {
                        ...
                        vertsRefID4 = id;
                        indexRange++;
                        UnityEngine.Debug.Log($"vertex4 block6 {id}");
                        next = false;
                    }
                    else
                    {
                ...
                if (next)
                {
                    ...
                    UnityEngine.Debug.Log($"vertex4 no block");
